...
class EncuestaLlvvType extends AbstractType
{
        /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('respuesta104', new SurveyType(), array('label' => 'respuesta10.4_llvv'))            
            ...
            ->add('respuesta131', new SurveyType(), array('label' => 'respuesta13.1_llvv'))
            ->add('respuesta132', new SurveyType(), array('label' => 'respuesta13.2_llvv'))
            ->add('respuesta133', new SurveyType(), array('label' => 'respuesta13.3_llvv'))
            ->add('respuesta134', new SurveyType(), array('label' => 'respuesta13.4_llvv'))
            ->add('respuesta135', new SurveyType(), array('label' => 'respuesta13.5_llvv'))
            ->add('respuesta136', new SurveyType(), array('label' => 'respuesta13.6_llvv'))
            ->add('respuesta137', new SurveyType(), array('label' => 'respuesta13.7_llvv'))
            ->add('respuesta138', new SurveyType(), array('label' => 'respuesta13.8_llvv'))
            ->add('respuesta139', new SurveyType(), array('label' => 'respuesta13.9_llvv'))
            ->add('respuesta1310', new SurveyType(), array('label' => 'respuesta13.10_llvv'))
