 ...
 */
class Mandante extends \BcTic\CamIpalBundle\Entity\Mandante implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'visible', 'pais', 'contratos');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Mandante $proxy) {
