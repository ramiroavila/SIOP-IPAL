...
class EncuestaObrasCivilesEditType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('respuesta13', new SurveyType(), array('label' => 'respuesta1.3_obras_civiles','disabled' => true))
            ->add('respuesta14', new SurveyType(), array('label' => 'respuesta1.4_obras_civiles','disabled' => true))
            ...
            ->add('respuesta34', new SurveyType(), array('label' => 'respuesta3.4_obras_civiles','disabled' => true))
            ->add('respuesta35', new SurveyType(), array('label' => 'respuesta3.5_obras_civiles','disabled' => true))
            ->add('respuesta41', new SurveyType(), array('label' => 'respuesta4.1_obras_civiles','disabled' => true))
            ->add('respuesta42', new SurveyType(), array('label' => 'respuesta4.2_obras_civiles','disabled' => true))
            ->add('respuesta43', new SurveyType(), array('label' => 'respuesta4.3_obras_civiles','disabled' => true))
            ->add('respuesta44', new SurveyType(), array('label' => 'respuesta4.4_obras_civiles','disabled' => true))
            ->add('respuesta45', new SurveyType(), array('label' => 'respuesta4.5_obras_civiles','disabled' => true))
            ->add('respuesta46', new SurveyType(), array('label' => 'respuesta4.6_obras_civiles','disabled' => true))
            ->add('respuesta47', new SurveyType(), array('label' => 'respuesta4.7_obras_civiles','disabled' => true))
            ->add('respuesta48', new SurveyType(), array('label' => 'respuesta4.8_obras_civiles','disabled' => true))
            ->add('respuesta49', new SurveyType(), array('label' => 'respuesta4.9_obras_civiles','disabled' => true))
            ->add('respuesta410', new SurveyType(), array('label' => 'respuesta4.10_obras_civiles','disabled' => true))
            ->add('respuesta411', new SurveyType(), array('label' => 'respuesta4.11_obras_civiles','disabled' => true))
            ->add('respuesta412', new SurveyType(), array('label' => 'respuesta4.12_obras_civiles','disabled' => true))
            ->add('respuesta51', new SurveyType(), array('label' => 'respuesta5.1_obras_civiles','disabled' => true))
            ->add('respuesta52', new SurveyType(), array('label' => 'respuesta5.2_obras_civiles','disabled' => true))
            ->add('respuesta53', new SurveyType(), array('label' => 'respuesta5.3_obras_civiles','disabled' => true))
            ->add('respuesta61', new SurveyType(), array('label' => 'respuesta6.1_obras_civiles','disabled' => true))
            ->add('respuesta62', new SurveyType(), array('label' => 'respuesta6.2_obras_civiles','disabled' => true))
            ->add('respuesta63', new SurveyType(), array('label' => 'respuesta6.3_obras_civiles','disabled' => true))
            ->add('respuesta64', new SurveyType(), array('label' => 'respuesta6.4_obras_civiles','disabled' => true))
            ->add('respuesta71', new SurveyType(), array('label' => 'respuesta7.1_obras_civiles','disabled' => true))
            ->add('respuesta72', new SurveyType(), array('label' => 'respuesta7.2_obras_civiles','disabled' => true))
            ->add('respuesta81', new SurveyType(), array('label' => 'respuesta8.1_obras_civiles','disabled' => true))
            ->add('respuesta82', new SurveyType(), array('label' => 'respuesta8.2_obras_civiles','disabled' => true))
            ->add('respuesta91', new SurveyType(), array('label' => 'respuesta9.1_obras_civiles','disabled' => true))
            ->add('respuesta92', new SurveyType(), array('label' => 'respuesta9.2_obras_civiles','disabled' => true))
            ->add('respuesta93', new SurveyType(), array('label' => 'respuesta9.3_obras_civiles','disabled' => true))
            ->add('respuesta101', new SurveyType(), array('label' => 'respuesta10.1_obras_civiles','disabled' => true))
            ->add('respuesta102', new SurveyType(), array('label' => 'respuesta10.2_obras_civiles','disabled' => true))
            ->add('respuesta103', new SurveyType(), array('label' => 'respuesta10.3_obras_civiles','disabled' => true))
            ->add('respuesta104', new SurveyType(), array('label' => 'respuesta10.4_obras_civiles','disabled' => true))
            ->add('respuesta111', new SurveyType(), array('label' => 'respuesta11.1_obras_civiles','disabled' => true))
            ->add('respuesta121', new SurveyType(), array('label' => 'respuesta12.1_obras_civiles','disabled' => true))
            ->add('respuesta131', new SurveyType(), array('label' => 'respuesta13.1_obras_civiles','disabled' => true))
            ->add('respuesta132', new SurveyType(), array('label' => 'respuesta13.2_obras_civiles','disabled' => true))
            ->add('respuesta133', new SurveyType(), array('label' => 'respuesta13.3_obras_civiles','disabled' => true))
            ->add('respuesta134', new SurveyType(), array('label' => 'respuesta13.4_obras_civiles','disabled' => true))
            ->add('respuesta135', new SurveyType(), array('label' => 'respuesta13.5_obras_civiles','disabled' => true))
            ->add('respuesta136', new SurveyType(), array('label' => 'respuesta13.6_obras_civiles','disabled' => true))
