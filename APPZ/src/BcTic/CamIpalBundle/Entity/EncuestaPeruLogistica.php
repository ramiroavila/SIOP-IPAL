 ...
 *
 */
class EncuestaPeruLogistica extends Encuesta
{
    ...
    public function getIncumplimientos() {
      $data = array();
      if ($this->getRespuesta11() == 1) $data[] = "respuesta1.1_peru_logistica";
      if ($this->getRespuesta12() == 1) $data[] = "respuesta1.2_peru_logistica";
      if ($this->getRespuesta13() == 1) $data[] = "respuesta1.3_peru_logistica";
      if ($this->getRespuesta14() == 1) $data[] = "respuesta1.4_peru_logistica";
      if ($this->getRespuesta15() == 1) $data[] = "respuesta1.5_peru_logistica";
      if ($this->getRespuesta21() == 1) $data[] = "respuesta2.1_peru_logistica";
      if ($this->getRespuesta31() == 1) $data[] = "respuesta3.1_peru_logistica";
      if ($this->getRespuesta32() == 1) $data[] = "respuesta3.2_peru_logistica";
      if ($this->getRespuesta33() == 1) $data[] = "respuesta3.3_peru_logistica";
      if ($this->getRespuesta34() == 1) $data[] = "respuesta3.4_peru_logistica";
      if ($this->getRespuesta41() == 1) $data[] = "respuesta4.1_peru_logistica";
      if ($this->getRespuesta42() == 1) $data[] = "respuesta4.2_peru_logistica";
      if ($this->getRespuesta43() == 1) $data[] = "respuesta4.3_peru_logistica";
      if ($this->getRespuesta44() == 1) $data[] = "respuesta4.4_peru_logistica";
      if ($this->getRespuesta45() == 1) $data[] = "respuesta4.5_peru_logistica";
      if ($this->getRespuesta46() == 1) $data[] = "respuesta4.6_peru_logistica";
      if ($this->getRespuesta47() == 1) $data[] = "respuesta4.7_peru_logistica";
      if ($this->getRespuesta48() == 1) $data[] = "respuesta4.8_peru_logistica";
      if ($this->getRespuesta49() == 1) $data[] = "respuesta4.9_peru_logistica";
      if ($this->getRespuesta410() == 1) $data[] = "respuesta4.10_peru_logistica";
      if ($this->getRespuesta411() == 1) $data[] = "respuesta4.11_peru_logistica";
      if ($this->getRespuesta51() == 1) $data[] = "respuesta5.1_peru_logistica";
      if ($this->getRespuesta52() == 1) $data[] = "respuesta5.2_peru_logistica";
      if ($this->getRespuesta53() == 1) $data[] = "respuesta5.3_peru_logistica";
      if ($this->getRespuesta61() == 1) $data[] = "respuesta6.1_peru_logistica";
      if ($this->getRespuesta62() == 1) $data[] = "respuesta6.2_peru_logistica";
      if ($this->getRespuesta63() == 1) $data[] = "respuesta6.3_peru_logistica";
      if ($this->getRespuesta64() == 1) $data[] = "respuesta6.4_peru_logistica";
      if ($this->getRespuesta65() == 1) $data[] = "respuesta6.5_peru_logistica";
      if ($this->getRespuesta71() == 1) $data[] = "respuesta7.1_peru_logistica";
      if ($this->getRespuesta72() == 1) $data[] = "respuesta7.2_peru_logistica";
      if ($this->getRespuesta81() == 1) $data[] = "respuesta8.1_peru_logistica";
      if ($this->getRespuesta82() == 1) $data[] = "respuesta8.2_peru_logistica";
      if ($this->getRespuesta91() == 1) $data[] = "respuesta9.1_peru_logistica";
      if ($this->getRespuesta92() == 1) $data[] = "respuesta9.2_peru_logistica";
      if ($this->getRespuesta93() == 1) $data[] = "respuesta9.3_peru_logistica";
      if ($this->getRespuesta101() == 1) $data[] = "respuesta10.1_peru_logistica";
      if ($this->getRespuesta102() == 1) $data[] = "respuesta10.2_peru_logistica";
      if ($this->getRespuesta103() == 1) $data[] = "respuesta10.3_peru_logistica";
      if ($this->getRespuesta111() == 1) $data[] = "respuesta11.1_peru_logistica";
      if ($this->getRespuesta121() == 0) $data[] = "respuesta12.1_peru_logistica";
      /*
      LOS INCUMPLIMIENTOS DE 13 NO APLICA PARA DEJAR COMO ABIERTO
      if ($this->getRespuesta131() == 1) $data[] = "respuesta13.1_peru_logistica";
      if ($this->getRespuesta132() == 1) $data[] = "respuesta13.2_peru_logistica";
      if ($this->getRespuesta133() == 1) $data[] = "respuesta13.3_peru_logistica";
      if ($this->getRespuesta134() == 1) $data[] = "respuesta13.4_peru_logistica";
      if ($this->getRespuesta135() == 1) $data[] = "respuesta13.5_peru_logistica";
      if ($this->getRespuesta136() == 1) $data[] = "respuesta13.6_peru_logistica";
      if ($this->getRespuesta137() == 1) $data[] = "respuesta13.7_peru_logistica";
      if ($this->getRespuesta138() == 1) $data[] = "respuesta13.8_peru_logistica";
      if ($this->getRespuesta139() == 1) $data[] = "respuesta13.9_peru_logistica";
      if ($this->getRespuesta1310() == 1) $data[] = "respuesta13.10_peru_logistica";
      */
      return $data;
    }
