 ...
 */
class Servicio extends \BcTic\CamIpalBundle\Entity\Servicio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nombre', 'area', 'visible', 'contratos');
        }
